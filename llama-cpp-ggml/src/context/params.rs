...
pub struct LlamaContextParams {
    pub(crate) context_params: ggml_all_sys_2::llama_context_params,
}
...
impl LlamaContextParams {
    ...
    ///     t: *mut ggml_all_sys_2::ggml_tensor,
    ///     ask: bool,
    ...
    pub fn with_cb_eval(
        mut self,
        cb_eval: ggml_all_sys_2::ggml_backend_sched_eval_callback,
    ) -> Self {
...
impl Default for LlamaContextParams {
    fn default() -> Self {
        let context_params = unsafe { ggml_all_sys_2::llama_context_default_params() };
        Self { context_params }
    }
}
