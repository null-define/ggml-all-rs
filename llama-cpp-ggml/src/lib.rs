...
pub fn llama_time_us() -> i64 {
    unsafe { ggml_all_sys_2::llama_time_us() }
}
...
pub fn max_devices() -> usize {
    unsafe { ggml_all_sys_2::llama_max_devices() }
}
...
pub fn ggml_time_us() -> i64 {
    unsafe { ggml_all_sys_2::ggml_time_us() }
}
...
extern "C" fn logs_to_trace(
    ...
    if level == ggml_all_sys_2::GGML_LOG_LEVEL_CONT {
...
pub fn send_logs_to_tracing(options: LogOptions) {
    ...
    unsafe {
        ...
        ggml_all_sys_2::llama_log_set(Some(logs_to_trace), llama_heap_state as *mut _);
        ggml_all_sys_2::ggml_log_set(Some(logs_to_trace), ggml_heap_state as *mut _);
    }
}
