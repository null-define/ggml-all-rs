...
pub struct LlamaModelParams {
    pub(crate) params: ggml_all_sys_2::llama_model_params,
    kv_overrides: Vec<ggml_all_sys_2::llama_model_kv_override>,
}
...
impl LlamaModelParams {
    ...
    pub fn append_kv_override(
        ...
        self.kv_overrides
            .push(ggml_all_sys_2::llama_model_kv_override {
                key: [0; 128],
                tag: 0,
                __bindgen_anon_1: ggml_all_sys_2::llama_model_kv_override__bindgen_ty_1 {
                    val_i64: 0,
                },
            });
...
impl Default for LlamaModelParams {
    fn default() -> Self {
        let default_params = unsafe { ggml_all_sys_2::llama_model_default_params() };
        LlamaModelParams {
