...
impl ParamOverrideValue {
    pub(crate) fn tag(&self) -> ggml_all_sys_2::llama_model_kv_override_type {
        match self {
            ParamOverrideValue::Bool(_) => ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_BOOL,
            ParamOverrideValue::Float(_) => ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_FLOAT,
            ParamOverrideValue::Int(_) => ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_INT,
            ParamOverrideValue::Str(_) => ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_STR,
        }
    }

    pub(crate) fn value(&self) -> ggml_all_sys_2::llama_model_kv_override__bindgen_ty_1 {
        match self {
            ParamOverrideValue::Bool(value) => {
                ggml_all_sys_2::llama_model_kv_override__bindgen_ty_1 { val_bool: *value }
            }
            ParamOverrideValue::Float(value) => {
                ggml_all_sys_2::llama_model_kv_override__bindgen_ty_1 { val_f64: *value }
            }
            ParamOverrideValue::Int(value) => {
                ggml_all_sys_2::llama_model_kv_override__bindgen_ty_1 { val_i64: *value }
            }
            ParamOverrideValue::Str(c_string) => {
                ggml_all_sys_2::llama_model_kv_override__bindgen_ty_1 { val_str: *c_string }
            }
        }
    }
}

impl From<&ggml_all_sys_2::llama_model_kv_override> for ParamOverrideValue {
    fn from(
        ggml_all_sys_2::llama_model_kv_override {
            key: _,
            tag,
            __bindgen_anon_1,
        }: &ggml_all_sys_2::llama_model_kv_override,
        ...
        match *tag {
            ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_INT => {
                ParamOverrideValue::Int(unsafe { __bindgen_anon_1.val_i64 })
            }
            ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_FLOAT => {
                ParamOverrideValue::Float(unsafe { __bindgen_anon_1.val_f64 })
            }
            ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_BOOL => {
                ParamOverrideValue::Bool(unsafe { __bindgen_anon_1.val_bool })
            }
            ggml_all_sys_2::LLAMA_KV_OVERRIDE_TYPE_STR => {
